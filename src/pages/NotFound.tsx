    ...
    <div className='h-full w-full bg-gray-50 flex items-center'>
      <div className='container flex flex-col md:flex-row items-center justify-between px-5 text-gray-700'>
        <div className='w-full lg:w-1/2 mx-8'>
          <div className='text-7xl text-danger font-dark font-extrabold mb-8'> 404</div>
          ...
          <Link
            to='/'
            className='px-5 inline py-3 text-sm font-medium leading-5 shadow-2xl text-white transition-all duration-400 border border-transparent rounded-lg focus:outline-none bg-primary uppercase'
          >
            Back to homepage
          </Link>
        </div>
        <div className='w-full h-full lg:flex lg:justify-end lg:w-1/2 mx-5 my-12'>
          <svg
